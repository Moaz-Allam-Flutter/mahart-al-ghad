...
const translations = {
    ...
    ar: {
        ...
        services_description: 'تقدم شركة مهارات الغد للصيانة والتشغيل مجموعة واسعة من الخدمات لصيانة وتحسين المباني والمرافق. من التنظيف الشامل والصيانة الموثوقة إلى رعاية الحدائق والعمليات الطبية الفعّالة، نضمن الخدمة عالية الجودة والفعالة باستخدام أحدث التقنيات وأفضل الممارسات.',
        ...
        landscaping_title: 'خدمات الرعاية والصيانة للمناظر الخارجية',
        ...
        copyright_text: '© 2024 شركة مهارات الغد للصيانة والتشغيل. كل الحقوق محفوظة.',
